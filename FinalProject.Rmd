...
avg_calories_by_category <- starbucks_data %>%
  group_by(Beverage_category) %>%
  summarise(Avg_Calories = mean(Calories, na.rm = TRUE))

ggplot(avg_calories_by_category, aes(x = reorder(Beverage_category, -Avg_Calories), y = Avg_Calories)) +
  geom_bar(stat = "identity", fill = "salmon") +
  labs(title = "Average Calories in Starbucks Beverages by Category",
       x = "Beverage Category", y = "Average Calories") +
